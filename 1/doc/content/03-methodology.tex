...
disabled, so in order to light the LEDs we first had to
enable the GPIO peripherals in the MCU's \emph{Clock Management Unit}
(\textbf{CMU}). \cite{EFM32GGManual} To enable the GPIO peripherals we set {\tt
CMU\_HFPERCLKEN0[GPIO]} to 1.
